...
import { X, LayoutDashboard, ArrowUpRight, PiggyBank, Settings, History, HelpCircle, LogOut } from "lucide-react"
...
export function MobileMenu({ isOpen, onClose, activeTab, setActiveTab }: MobileMenuProps) {
  const navItems = [
